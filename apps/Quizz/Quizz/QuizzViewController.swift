...
class QuizzViewController: UIViewController {
    ...
    init() {
        ...
        questions.append("When did the first Star Wars movie come out?")
        answers.append("May 25th 1977")

        questions.append("What is the capital of Assyria?")
        answers.append("Aššur")
